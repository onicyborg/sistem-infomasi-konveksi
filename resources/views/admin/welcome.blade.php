            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Generate Excel Report</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('purchase_orders.export') }}" method="POST">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" name="export_all" class="form-check-input" id="export_all"
                                    value="1">
                                <label class="form-check-label" for="export_all">Export All Data</label>
                            </div>
