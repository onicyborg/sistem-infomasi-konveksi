...
@section('title')
    Pesanan Pembuatan Pola - Kepala Produksi
@endsection
    ...
    <div class="container-fluid">
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pembuatan Pola</li>
                </ol>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title">List Pesanan Pada Proses Pembuatan Pola</h4>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/kepala-produksi/orders-pattern/{{ $order->id }}"
